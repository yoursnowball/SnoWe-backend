...
enum class ErrorCode(
    ...
    METHOD_ARGUMENT_NOT_VALID("SYSTEM-004", "유효하지 않은 파라미터 값 요청입니다.", HttpStatus.BAD_REQUEST),
    METHOD_ARGUMENT_TYPE_MISMATCH("SYSTEM-005", "잘못된 파라미터 요청입니다.", HttpStatus.BAD_REQUEST),
    ...
    PUSH_MESSAGE_ERROR("ALARM-002", "푸시 알람 전송에 실패 했습니다.", HttpStatus.INTERNAL_SERVER_ERROR)
